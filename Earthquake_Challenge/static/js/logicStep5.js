//Add console.log to check if it is working 
console.log("working");
...
// This function determines the color of the circle based on the magnitude of an earthquake
...
// Retrieve the teactonic plate GeoJSON data.
